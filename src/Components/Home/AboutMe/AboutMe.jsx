        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <h2
                            className="text-xl font-bold mt-6 lg:text-start text-center px-2">
                            Social Media Links:
                        </h2>
                        {/* link */}
                        <div
                            ...
                            <Link
                                ...
                                <p
                                    className="font-bold py-1 px-2 rounded-lg mt-1 lg:mb-0 mb-5">
                                    <span
                            ...
                            <Link
                                ...
                                <p
                                    className="font-bold py-1 px-2 rounded-lg mt-1">
                                    <span
                                        className="flex items-center justify-center">
                                        Shakil Ahmed <TbExternalLink className="text-xl ms-1" />
                                    </span>
