...
const Skills = () => {
    return (
        <div
            ...
            ></SectionTitle>
            <div
                className="max-w-7xl mx-auto py-8 rounded-lg my-10 grid grid-cols-3 lg:grid-cols-7 px-2 gap-2">
                {/* html */}
                <div
                    data-aos="zoom-in"
                    ...
                    <p
                        className="font-bold text-center bg-black text-white w-[75%] mx-auto rounded-md py-1 lg:text-sm text-xs">
                        HTML
                    </p>
                </div>
                {/* css */}
